...
import { SimilarityContext } from '@similarity/similarity-rule.interface';
import { TextSimilarityRule } from './base/text-similarity.rule';

/**
 * Scores venue similarity. Weight 0.3.
 * Overrides `substringScore` to 0.9 — partial venue name matches
 * (e.g. "ACE" vs "ACE Conference Hall, ICT") are highly reliable.
 */
@Injectable()
