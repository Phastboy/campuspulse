...
export const configSchema = z
  ...
  .refine(
    (d) => !d.SWAGGER_ENABLED || (!!d.SWAGGER_USER && !!d.SWAGGER_PASS && !!d.SWAGGER_SECURITY_NAME),
    {
      message: 'SWAGGER_USER, SWAGGER_PASS, and SWAGGER_SECURITY_NAME are required when SWAGGER_ENABLED is true',
