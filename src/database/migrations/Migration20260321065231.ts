...
export class Migration20260321065231 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`create table "events" ("id" uuid not null default uuid_generate_v4(), "title" varchar(255) not null, "datetime" jsonb not null, "venue" varchar(255) not null, "description" varchar(255) null, "created_by" uuid null, "created_at" timestamptz not null, primary key ("id"));`);

    this.addSql(`create table "users" ("id" uuid not null default uuid_generate_v4(), "email" varchar(255) not null, "google_id" varchar(255) null, "password" varchar(255) null, "username" varchar(255) not null, "created_at" timestamptz not null, primary key ("id"));`);
    ...
    this.addSql(`create table "refresh_tokens" ("id" uuid not null default uuid_generate_v4(), "token" varchar(255) not null, "user_id" varchar(255) not null, "expires_at" timestamptz not null, "created_at" timestamptz not null, primary key ("id"));`);
    this.addSql(`create index "refresh_tokens_token_index" on "refresh_tokens" ("token");`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`create table "auth"."audit_log_entries" ("instance_id" uuid null, "id" uuid not null, "payload" json null, "created_at" timestamptz(6) null, "ip_address" varchar(64) not null default '', primary key ("id"));`);
    ...
    this.addSql(`create table "storage"."buckets_vectors" ("id" text not null, "type" storage.buckettype not null default 'VECTOR', "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) not null default now(), primary key ("id"));`);
    ...
    this.addSql(`create index "flow_state_created_at_idx" on "auth"."flow_state" ("created_at" DESC);`);
    ...
    this.addSql(`create table "auth"."mfa_challenges" ("id" uuid not null, "factor_id" uuid not null, "created_at" timestamptz(6) not null, "verified_at" timestamptz(6) null, "ip_address" inet not null, "otp_code" text null, "web_authn_session_data" jsonb null, primary key ("id"));`);
    this.addSql(`comment on table "auth"."mfa_challenges" is 'auth: stores metadata about challenge requests made';`);
    this.addSql(`create index "mfa_challenge_created_at_idx" on "auth"."mfa_challenges" ("created_at" DESC);`);
    ...
    this.addSql(`create table "storage"."migrations" ("id" int4 not null, "name" varchar(100) not null, "hash" varchar(40) not null, "executed_at" timestamp(6) null default CURRENT_TIMESTAMP, primary key ("id"));`);
    ...
    this.addSql(`create table "auth"."oauth_client_states" ("id" uuid not null, "provider_type" text not null, "code_verifier" text null, "created_at" timestamptz(6) not null, primary key ("id"));`);
    ...
    this.addSql(`create table "auth"."oauth_consents" ("id" uuid not null, "user_id" uuid not null, "client_id" uuid not null, "scopes" text not null, "granted_at" timestamptz(6) not null default now(), "revoked_at" timestamptz(6) null, primary key ("id"));`);
    ...
    this.addSql(`create index "oauth_consents_user_order_idx" on "auth"."oauth_consents" ("user_id", "granted_at" DESC);`);
    ...
    this.addSql(`create index "idx_objects_bucket_id_name" on "storage"."objects" ("bucket_id", "name" collate "C");`);
    ...
    this.addSql(`create table "auth"."one_time_tokens" ("id" uuid not null, "user_id" uuid not null, "token_type" auth.one_time_token_type not null, "token_hash" text not null, "relates_to" text not null, "created_at" timestamp(6) not null default now(), "updated_at" timestamp(6) not null default now(), primary key ("id"));`);
    ...
    this.addSql(`create index "refresh_tokens_updated_at_idx" on "auth"."refresh_tokens" ("updated_at" DESC);`);
    ...
    this.addSql(`create table "auth"."saml_providers" ("id" uuid not null, "sso_provider_id" uuid not null, "entity_id" text not null, "metadata_xml" text not null, "metadata_url" text null, "attribute_mapping" jsonb null, "created_at" timestamptz(6) null, "updated_at" timestamptz(6) null, "name_id_format" text null, primary key ("id"));`);
    ...
    this.addSql(`create table "auth"."saml_relay_states" ("id" uuid not null, "sso_provider_id" uuid not null, "request_id" text not null, "for_email" text null, "redirect_to" text null, "created_at" timestamptz(6) null, "updated_at" timestamptz(6) null, "flow_state_id" uuid null, primary key ("id"));`);
    ...
    this.addSql(`create index "saml_relay_states_created_at_idx" on "auth"."saml_relay_states" ("created_at" DESC);`);
    ...
    this.addSql(`create table "realtime"."schema_migrations" ("version" int8 not null, "inserted_at" timestamp(0) null, primary key ("version"));`);
    ...
    this.addSql(`create index "sessions_not_after_idx" on "auth"."sessions" ("not_after" DESC);`);
    ...
    this.addSql(`create table "auth"."sso_domains" ("id" uuid not null, "sso_provider_id" uuid not null, "domain" text not null, "created_at" timestamptz(6) null, "updated_at" timestamptz(6) null, primary key ("id"));`);
    ...
    this.addSql(`create table "auth"."sso_providers" ("id" uuid not null, "resource_id" text null, "created_at" timestamptz(6) null, "updated_at" timestamptz(6) null, "disabled" bool null, primary key ("id"));`);
    ...
    this.addSql(`create unique index "subscription_subscription_id_entity_filters_action_filter_key" on "realtime"."subscription" ("subscription_id", "entity", "filters", "action_filter");`);
    ...
    this.addSql(`create unique index "vector_indexes_name_bucket_id_idx" on "storage"."vector_indexes" ("name", "bucket_id");`);

    this.addSql(`create table "auth"."webauthn_challenges" ("id" uuid not null default gen_random_uuid(), "user_id" uuid null, "challenge_type" text not null, "session_data" jsonb not null, "created_at" timestamptz(6) not null default now(), "expires_at" timestamptz(6) not null, primary key ("id"));`);
    ...
    this.addSql(`create unique index "webauthn_credentials_credential_id_key" on "auth"."webauthn_credentials" ("credential_id");`);
    ...
    this.addSql(`create view "extensions"."pg_stat_statements_info" as SELECT dealloc,
    stats_reset
